...
In this experiment, 84 squats were performed, observed both by the application and an expert. Figure~\ref{fig:scorediff} shows a radial plot with the expert awarded score in blue, and the application awarded score in red:
