...
\begin{figure}[H]
	...
	\begin{tabular}{ | p{3cm} | p{10cm} | }
		...
		\parbox{3cm}{WEIGHT\_\\DISTRIBUTION\_ BACKWARD} & \parbox{10cm}{\vspace{.5\baselineskip}
		...
		\parbox{3cm}{WEIGHT\_\\DISTRIBUTION\_ FORWARD} & \parbox{10cm}{\vspace{.5\baselineskip}
		...
		HIP\_KNEE\_RATE & \parbox{10cm}{\vspace{.5\baselineskip}
